  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={openAdd} className="bg-indigo-600 hover:bg-indigo-500 text-white text-sm px-4 py-2 rounded-lg transition-colors">+ Add Debt</button>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-gray-600"><p className="text-4xl mb-3">💳</p><p>No debts tracked. Add one to stay on top of it.</p></div>
      ) : (
