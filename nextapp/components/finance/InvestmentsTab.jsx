  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={openAdd} className="bg-indigo-600 hover:bg-indigo-500 text-white text-sm px-4 py-2 rounded-lg transition-colors">+ Add Investment</button>
      </div>
      ...
      {showForm && (
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className="text-xs text-gray-400">Cost Basis</label>
      ...
      {loading ? (
        ...
        <div className="text-center py-12 text-gray-600"><p className="text-4xl mb-3">📈</p><p>No investments yet. Add your portfolio.</p></div>
      ) : (
